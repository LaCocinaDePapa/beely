...
const App = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-0 z-[-2] h-screen w-screen bg-neutral-100 text-black dark:text-neutral-100 dark:bg-neutral-950 dark:bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] transition-all ease-in-out duration-150"></div>
      <Navbar />
      <Routes>
        {/* Public routes */}
