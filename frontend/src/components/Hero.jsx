  ...
  return (
    <section className="px-8">
      <div className="flex justify-center mt-16 md:mb-7 lg:mt-40 md:mt-32">
        <h1 className="text-[30px] font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-pink-600 to-purple-600 md:text-[47px] lg:text-[60px]">Streamline Your URL Management</h1>
      </div>
      <div>
