...
export const Login = () => {
  ...
  return (
    <section className='flex justify-center px-4 mt-28 min-h-min sm:px-6 lg:px-8 lg:mt-40'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-8 mt-16'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='text-sm'>
                <a href='/#' className='form-medium text-sky-600 hover:text-sky-700 dark:text-slate-300 dark:hover:text-slate-400'
                >
      ...
      <p className='mt-8'>
        <Link className='text-sky-600 hover:text-sky-700 dark:text-slate-300 dark:hover:text-slate-400' to='/signup'>Don't have an account ?</Link>
      </p>
